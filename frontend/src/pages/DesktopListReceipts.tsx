        ...
        <div className="left_side">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <input
                    ...
                    name="amountFrom"
                    value={
                      filters.amountFrom !== null ? filters.amountFrom : ""
                    }
                    onChange={handleFilterChange}
          ...
          <div className="w-full px-10">
            <div className="max-h-[400px] lg:max-h-[350px] overflow-y-auto">
              <table className="receipt-table table border-collapse">
                <thead>
                  <tr>
                    <th className="p-2 border-b-2 border-black text-left text-sm font-normal text-black">
                      Company
                    </th>
                    <th className="p-2 border-b-2 border-black text-left text-sm font-normal text-black">
                      Date
                    </th>
                    <th className="p-2 border-b-2 border-black text-right text-sm font-normal text-black">
                      Amount
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {receipts?.map((receipt: receiptType) => (
                    ...
                    >
                      ...
                      {/* REMOVED <td className="p-2 border-b border-gray-300 text-left">
                        <svg
                          onClick={(e) => {
